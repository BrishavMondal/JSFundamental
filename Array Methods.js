...
console.log("11c - indexOf Python:", techStack.indexOf("Python")); 
console.log("11d - indexOf Vue:",    techStack.indexOf("Vue"));    
...
const removed = techList.splice(2, 1, "JavaScript", "TypeScript"); 
